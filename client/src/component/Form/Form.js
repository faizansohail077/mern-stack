...
// import { upadatePost } from '../../../../server/controllers/posts'
    ...
    <Paper className={classes.paper}>
      <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <div className={classes.fileInput}>
          ...
          <Button variant="contained" className={classes.buttonSubmit} color="secondary" size="small" onClick={clear} fullWidth >Delete</Button>
        </div>
      </form>
